...
class RegisterSerializer(serializers.Serializer):
    ...
    Job_title = serializers.CharField(required=True, write_only=True)
    Experience = serializers.CharField(required=True, write_only=True)
    nationality = serializers.CharField(required=True, write_only=True)
