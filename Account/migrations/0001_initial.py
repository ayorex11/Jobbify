    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Experience', models.CharField(blank=True, max_length=250)),
                ...
                ('user_type', models.CharField(blank=True, choices=[('Job Seeker', 'Job Seeker'), ('Employer', 'Employer')], max_length=30, null=True, verbose_name='user type')),
